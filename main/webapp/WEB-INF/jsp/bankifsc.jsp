...
<body>
	...
	<div class="form-group">
		<form:form id="locateForm" modelAttribute="searchbycode" action="bankifscProcess" method="post">
			<table class="table table-hover">
				<tr>
					<td><form:label path="code">IFSC CODE : </form:label></td>
					<td><form:input path="code" name="code" id="code"/></td>
				</tr>
				<tr>
