	...
	<form:form id="payForm" modelAttribute="neft" action="payvianeftrtgsProcess" method="post" class="needs-validation">
		...
		<table class="table table-hover">
			...
			<tr>
				...
				<table class="table table-hover">
				<tr>
					<th colspan=2><h3 style="text-align:center"><strong>Reciever's Details</strong></h3></th>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan=2><form:textarea path="remark" name="remark" id="remark" required="true"/></td>
				</tr>
