...
<body>
	<div class="jumbotron">
  		<div class="container">
			...
			<c:set var = "noUpdate" scope = "session" value = "Not Valid PAN"/>	
...
<table class="table table-striped" style="cellpadding:0;cellspacing:0">
<tr>
<td><img src="resources/pan.png" style="height:35%"></td>
<td>
	
	<form:form id="aadhaarForm" modelAttribute="UIDAI" action="linkPanProcess" method="post" class="needs-validation">
		<table class="table table-striped">
			...
			<tr>
				<th><form:label path="aadhaar">Aadhaar Number</form:label></th>
				<td><form:input path="aadhaar" name="aadhaar" id="aadhaar" class="form-control" required="true" readonly="true"/></td>
			</tr>
			</core:if>
			<tr>
				<th><form:label path="pan">PAN number(10 - digit)</form:label></th>
				<core:if test="${UIDAI.pan == null}">
					<td><form:input path="pan" name="pan" id="pan" class="form-control" required="true"/></td>
				</core:if>
				<core:if test="${UIDAI.pan != null}">
