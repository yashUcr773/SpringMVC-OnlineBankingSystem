...
public class TempController {
  ...
  public ModelAndView showLogin(HttpServletRequest request, HttpServletResponse response) {
    ...
    mav.addObject("captcha", login.getDisplayedcaptcha());
  ...
  @ModelAttribute("login") Login login) {
    ...
    if(!login.getDisplayedcaptcha().equals(login.getEnteredcaptcha()))
    {
    	ModelAndView mav2 = new ModelAndView("temp");
