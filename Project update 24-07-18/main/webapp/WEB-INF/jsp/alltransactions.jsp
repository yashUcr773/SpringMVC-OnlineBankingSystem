...
<div class="jumbotron">
		...
		<tr>
			<td style="text-align: right"><a href="generateallpdf" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Generate Pdf</a></td>
			<td><a href="exportalltoexcel" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Export to Excel</a></td>
		</tr>
