...
<body>
	<div class="jumbotron">
		...
		<tr>
			<td style="text-align:right"><a href="changepassword" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">ChangePassword</a></td>
			<td colspan=2><a href="bankifsc" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Bank Details via IFSCode</a></td>
		</tr>
		<tr>
			...
			<td colspan=2><a href="linkpan" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Link Pan</a></td>
		</tr>
	</table>
